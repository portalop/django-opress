...
from taggit.models import TagBase, GenericTaggedItemBase, CommonGenericTaggedItemBase
...
class IPUser(models.Model):
    ip_addr = models.GenericIPAddressField('IP')
...
class LocationTags(GenericTaggedItemBase):
    tag = models.ForeignKey(LocationTag, related_name='localidad')
